...
train_no_dir = 'data/makeup_with_labels/train/no_makeup/'
train_yes_dir = 'data/makeup_with_labels/train/yes_makeup/'
val_no_dir = 'data/makeup_with_labels/val/no_makeup/'
val_yes_dir = 'data/makeup_with_labels/val/yes_makeup/'
